...
httr.paths <- c(list.files(paste0(local.data.path, "sampled_data/httr/2_reps/"), full.names = TRUE),
                list.files(paste0(local.data.path, "sampled_data/httr/3_reps/"), full.names = TRUE))
httr.nms <- c(list.files(paste0(local.data.path, "sampled_data/httr/2_reps/"), full.names = FALSE),
              list.files(paste0(local.data.path, "sampled_data/httr/3_reps/"), full.names = FALSE))
httr.nms <- gsub(".parquet", "", httr.nms)

htpp.paths <- c(list.files(paste0(local.data.path, "sampled_data/htpp/2_reps/"), full.names = TRUE),
                list.files(paste0(local.data.path, "sampled_data/htpp/3_reps/"), full.names = TRUE))
htpp.nms <- c(list.files(paste0(local.data.path, "sampled_data/htpp/2_reps/"), full.names = FALSE),
              list.files(paste0(local.data.path, "sampled_data/htpp/3_reps/"), full.names = FALSE))
...
wt.paths <- list.files(paste0(local.data.path, "WTT_results"), full.names = TRUE)
...
write_parquet(httr.wt.filter, paste0(local.data.path, "filtered_features/httr_wtt_filter.parquet"))
write_parquet(httr.aov.filter, paste0(local.data.path, "filtered_features/httr_aov_filter.parquet"))
write_parquet(htpp.aov.filter, paste0(local.data.path, "filtered_features/htpp_aov_filter.parquet"))
...
write_parquet(httr.bmd.res, paste0(local.data.path, "bmd_results/httr_bmd_all.parquet"))
...
write_parquet(htpp.bmd.res, paste0(local.data.path, "bmd_results/htpp_bmd_all.parquet"))
...
write_parquet(httr.bmd.nomic, paste0(local.data.path, "bmd_results/httr_bmd_nomic.parquet"))
write_parquet(httr.bmd.s1500, paste0(local.data.path, "bmd_results/httr_bmd_s1500.parquet"))
write_parquet(httr.bmd.aov, paste0(local.data.path, "bmd_results/httr_bmd_aov.parquet"))
write_parquet(httr.bmd.wtt, paste0(local.data.path, "bmd_results/httr_bmd_wtt.parquet"))
write_parquet(htpp.bmd.aov, paste0(local.data.path, "bmd_results/htpp_bmd_aov.parquet"))
